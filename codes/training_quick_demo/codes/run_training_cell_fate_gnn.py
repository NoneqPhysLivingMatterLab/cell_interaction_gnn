...
import gnn_models_quick as gnn_models
import pathlib
import time
...
# training_path_list and test_path_list are the lists of the graph created by dgl.
# cellID_training_path_list and cellID_test_path_list are the lists of  the cell IDs of target cells at the final layer of each network.


training_path_list = ["../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=0to3.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=1to4.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=2to5.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=3to6.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=4to7.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=5to8.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=6to9.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=7to10.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=8to11.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=9to12.pickle",
                      "../data/simulation/del-div/sample0/graphs/NetworkWithFeartures_t=10to13.pickle"]

cellID_training_path_list = ["../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=0to3.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=1to4.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=2to5.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=3to6.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=4to7.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=5to8.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=6to9.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=7to10.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=8to11.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=9to12.txt",
                             "../data/simulation/del-div/sample0/cellIDs/CellID_FinalLayer_t=10to13.txt"]

test_path_list = ["../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=0to3.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=1to4.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=2to5.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=3to6.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=4to7.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=5to8.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=6to9.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=7to10.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=8to11.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=9to12.pickle",
                  "../data/simulation/del-div/sample1/graphs/NetworkWithFeartures_t=10to13.pickle"]
cellID_test_path_list = ["../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=0to3.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=1to4.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=2to5.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=3to6.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=4to7.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=5to8.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=6to9.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=7to10.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=8to11.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=9to12.txt",
                         "../data/simulation/del-div/sample1/cellIDs/CellID_FinalLayer_t=10to13.txt"]
...
crop_height_list_train = crop_width_list_train
crop_width_list_test = yaml_obj["crop_width_list_test"]
crop_height_list_test = crop_width_list_test
...
#result_dir_name_base = "%s_fnum%d_time%d_net%s_ptest%d_noself%d_inplane%d_skip%d_nullnet%d_ave%d_edge%d_reg%d-%d_nullw%d_even%d/"%(architecture,input_size,num_time,network_num,partial_test,NoSelfInfo,in_plane,skip,null_net,average_switch,edge_switch,reg,norm_final,null_weight,num_even)
#result_dir_name = result_dir_name_base + "%s_model=%d_epoch=%d_hidnode=%d_lr=%f_opt=%s_feature=%s_infeats=%d_penalty=%.1f_shuffle=%d_noself=%d_drop=%.2f_wd=%.6f_inplane=%d_omitt0=%d_border=%d_ptest=%d_layer=%d"%(ver,model_ver,epoch_total,hid_node,learning_rate,opt_name,feature,in_feats,penalty_zero,shuffle,NoSelfInfo,p_hidden,weight_decay,in_plane,omit_t0,border,partial_test,n_layers)
